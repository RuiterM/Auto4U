    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a id="header_btn" class="nav-link text-light" href="/Contact.php">Contact</a>
                </li>
                <li class="nav-item">
                    <a id="header_btn" class="nav-link text-light" href="/member/profile">Profiel</a>
                </li>
                <li class="nav-item me-auto">
                    <a id="header_btn2" class="nav-link text-dark" style="margin-left: 1400px" href="/login">Login</a>
                </li>
                <li class="nav-item me-auto">
